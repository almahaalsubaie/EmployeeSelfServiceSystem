...
if ($stmtRecent->execute() === false) {
    die("Execute failed: " . $stmtRecent->error);
}
...
<td style="font-size: 40px; color:#AB3535"><?php echo $rejectedRequests; ?></td>
                ...
                <div class="EtitlesRow"><h2 style="margin-left: 120px;">Recent Requests</h2> 
                <h2>Active Requests</h2></div>
                ...
                <div class="dashRow">
                    ...
                    <div class="dash3Container">
                        <br><br>
                       <a href="ApplyingRequest.php">
    <button class="view-button" style="width:100%; padding-left:24px; padding-right:24px;"> New Request </button>
</a>
<br>
<a href="ViewRequests.php">
    <button class="view-button" style="width:100%">Track Requests</button>
</a>
