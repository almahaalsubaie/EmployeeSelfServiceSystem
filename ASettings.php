...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['isEnabled'])) {
    ...
    // Update the A_isNotifiEnabled value in the HR_Admin table
    $sql = "UPDATE HR_Admin SET A_isNotifiEnabled = ? WHERE A_ID = ?";
    ...
    if ($stmt->execute()) {
        ...
        $message = 'Error updating notification settings: ' . $conn->error;
    }
...
$sql = "SELECT A_isNotifiEnabled FROM HR_Admin WHERE A_ID = ?";
$stmt = $conn->prepare($sql);
        ...
        <div class="sidebar">
            ...
            <nav>
                <ul>
                    ...
                    <li><br></li>
                    <li><br></li>
                    <li><a href="settings.php"><i class="fas fa-cog icon"></i><span class="label">Settings</span></a></li>
